#
#  Be sure to run `pod spec lint EduLogic.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "EduLogic"
  spec.version      = "0.0.1"
  spec.summary      = "A module of educational business."
  ...
  spec.description  = "A module of educational business."
  ...
  # Or just: spec.author    = "yuanyuan"
  # spec.authors            = { "yuanyuan" => "guoyuanyuan02@corp.netease.com" }
  # spec.social_media_url   = "https://twitter.com/yuanyuan"
...
#   spec.osx.deployment_target = "10.7"
  ...
  spec.source_files  = "EduLogic", "EduLogic/**/*.{h,m}"
...
#   spec.frameworks = "NEScreenShareBroadcaster", "NEScreenShareHost"
