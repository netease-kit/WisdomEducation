export default {
  '课程还未开始，请耐心等待哦':
    'The class is not started. Please wait for a moment',
  '老师暂离，请耐心等待老师回来哦～':
    'The teacher is off at the moment. Please wait for a while',
  ...
  '已有人在共享，您无法共享':
    'Someone is already sharing screen. You cannot share your screen',
  ...
  '离开教室后将暂停学习，需要等待您再次进入课堂后方可继续上课？':
    'If you leave a class, the class will be paused. The class will be resumed after you rejoin the class. Are you sure you want to leave the class?',
  '离开教室后将暂停教学，学生需要等待您再次进入课堂后方可继续上课。':
    'Teaching will be suspended after leaving the classroom, and students need to wait for you to re-enter the classroom before continuing the lesson.',
  '开课后教学内容将同步至学生端，并正式开始课堂录制':
    'If the class starts, the class stream will be synced to student clients, and the class recording will start',
  '结束课堂后老师和学生均会跳转课堂结束画面，支持查看课程回放':
    'If a class ends, teachers and students will be directed to the class completion page. You can view the class recordings',
  '下讲台后，你的视频画面将不再显示在屏幕上，不能继续与老师语音交流。':
    'If you are moved to audience, your screen will not be displayed on the canvas and you cannot communicate with teachers over voice.',
  复制成功: 'Copied',
  课堂号: 'Class ID',
  课堂名称: 'Class Name',
  老师: 'Teacher',
  ...
  全部成员: 'All',
  搜索: 'Search',
  '全体静音为默认关闭所有成员的麦克风，但成员依旧能主动开启':
    'By default, Mute All allows you to silence all the members but members can still unmute their microphones',
  课堂成员: 'Members',
  聊天室: 'Chat room',
  全体静音: 'Mute all',
  静音: 'Mute',
  ...
  音频输出设备: 'Audio output',
  '异常，请重新进行设备选择和检测！':
    'Error. Select and detect the device again!',
  聊天室全体禁言: 'Chat room are all muted',
  同意: 'Accept',
  拒绝: 'Decline',
  举手申请被拒绝: 'The request to speak was rejected',
  '您的举手申请被拒绝，请稍后再尝试。':
    'Your request to speak was rejected. Please try again later.',
  ...
  '结束该学生的上台动作，同时收回他的屏幕共享、白板权限':
    'Move the student to audience and revoke screen sharing and whiteboard permissions',
  上一页: 'Previous Page',
  上一步: 'Previous Step',
  下一步: 'Next Step',
  下一页: 'Next Page',
  ...
  '确认离开？系统可能不会保存您的更改。':
    'Confirm to leave? Your changes may not be saved.',
  ...
  创建房间时房间已经存在且房间类型冲突:
    'The room already exists and room type conflicts',
  ...
  '网易云信在线教育场景方案助您快速搭建专属在线课堂，':
    'CommsEase enables you to quickly build committed online classes,',
  '支持一对一、小班课、大班课多种教育场景。':
    'Wisdom Education supports one-on-one tutoring, breakout classes, and large classes.',
  '基于新一代音视频通话2.0产品，为您提供超低延时、高清稳定的音视频体验。':
    'and provides low-latency and reliable HD audio and video experiences based on a new generation of Audio & Video call SDK.',
  ...
  '本产品仅用于演示产品功能，课堂最长30分钟，不可商用':
    'This product is used only for demo purpose. Each class lasts 30 minutes at most. Commercial use is not allowed',
  设置: 'Settings',
  '课程结束后，需进行文件转码，预计20分钟后可观看回放':
    'If a class ends, it takes time to transcode recordings. You can view recordings after 20 minutes',
  ...
  图片或文件大小最大支持100M:
    'An image or file in a maximum of 100MB is allowed',
  ...
  失败: 'failed',
  '获取麦克风或摄像头权限时，设备被占用。':
    'The device is occupied when accessing the microphone or camera',
  '视频输入设备异常，请重新进行设备选择和检测！':
    'Video input device error. Try again.',
  请先初始化聊天室实例并成功登录后再调用该方法:
    'To call the method, you must first initialize a chat room instance and log in to the instance',
  ...
  '申请上台与老师沟通，通过后你的视频画面将出现在屏幕上并能与老师语音':
    'Request to speak with teachers. If the request is accepted, your screen will appear on the canvas and you can communicate with teachers over voice',
  老师端推流: 'Teacher Streaming',
  该房间已关闭: 'The room is closed',
  '上传超时，请重试': 'Upload timed out, please try again',
  暂不支持当前浏览器: 'The current browser is not supported',
  '请使用Google Chrome浏览器打开': 'Please use Google Chrome to open',
  下载Chrome: 'Download Chrome',
}
