...
object PreferenceUtil {
    ...
    private const val KEY_ENABLE_HOST_LIVE = "KEY_ENABLE_HOST_LIVE"
    ...
    var enableHostLive: Boolean
        get() {
            return get(KEY_ENABLE_HOST_LIVE, false)
        }
        set(enable) {
            put(KEY_ENABLE_HOST_LIVE, enable)
        }
}