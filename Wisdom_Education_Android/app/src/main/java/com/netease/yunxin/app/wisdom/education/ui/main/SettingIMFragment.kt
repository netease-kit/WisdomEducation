...
import com.netease.yunxin.app.wisdom.education.databinding.SettingImFragmentBinding
...
class SettingIMFragment : Fragment(R.layout.setting_im_fragment), Observer<StatusCode> {
    private val binding: SettingImFragmentBinding by viewBinding()

    companion object {
        fun newInstance() = SettingIMFragment()
    }
